...
```bash
git clone [https://github.com/matheusrodrigues1/previsao_de_rotatividade_de_cliente](https://github.com/matheusrodrigues1/previsao_de_rotatividade_de_cliente)
cd PROJETO_ML
```
